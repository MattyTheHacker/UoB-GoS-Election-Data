...
def get_election_list():
    ...
    utils.save_formatted_data(election_list, "data/all_elections_active_list.json")

    # save the election list to a csv file
    utils.save_dictionary_to_csv(election_list, "csv/all_elections_active_list.csv")
